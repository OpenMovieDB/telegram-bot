...
Система оплаты в телеграм-боте Poiskkino API реализует полный цикл обработки платежей с поддержкой нескольких платежных систем и системы скидок при смене тарифа.
