...
export const BUTTONS = {
  ...
  [CommandEnum.QUESTION]: Markup.button.callback('задать вопрос 🥹', CommandEnum.QUESTION),
  ...
  [CommandEnum.UPDATE_TARIFF]: Markup.button.callback('🔥 сменить тариф', CommandEnum.UPDATE_TARIFF),
  [CommandEnum.GET_MY_TOKEN]: Markup.button.callback('🔑 мой токен', CommandEnum.GET_MY_TOKEN),
  [CommandEnum.CHANGE_TOKEN]: Markup.button.callback('✏️ сменить токен', CommandEnum.CHANGE_TOKEN),
  ...
  [CommandEnum.UPDATE_MOVIE]: Markup.button.callback('🔄️ обновить фильмы', CommandEnum.UPDATE_MOVIE),
